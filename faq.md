...
Last updated 2018-01-11 07:30 UTC
...
If not copied, you need to insert a Player infobox __first__, and fill out the necessary details. For the `time` field, put `{{Time widget|<YOUR TIMEZONE CODE>}}`. Then add text to the rest of the article using the editor. The most important section is **Characters**, which will contain a list of links to your characters. Make them `[[links]]` to the desired page name, as the page need not exist to make a link. You will create your character pages next.
...
Go to <http://avalice.wikia.com/wiki/Character_Creation> and follow the instructions there.
...
__Write however you want, but please stick to one style for the duration of a scene.__ If you're not sure, or don't have a favorite style, the following is generally accepted and easy to understand. Dialogue goes in quotes: “like this.” If you need to speak out of character, use parenthesis on each end, (like this). To specify an action, put it \**in italics*\*. Quotes in italics are used for when a character is thinking to themself. \*\***Bold**\*\* can be used for yelling or otherwise emphasizing something. Telepathy or text messages usually go in backticks to make it \``monospace`\` or triple backticks to make it a full code block.
...
**Campaign roles:** These roles are assigned when a player joins an established campaign, and grant the ability to post in that campaign's IC channel.
...
**Content channels:**
- **#creative-corner:** An artist/creative type discussion channel.
...
**Tabletop channels:** These channels are targeted towards structured RP with a GM.
...
**Campaign channels:** Established campaigns each have their own channel category and self-explanatory title. See their descriptions for more information.
...
- Some character makers, for quick and easy visualization of a character's appearance:
...
- Some session scheduling tools:
  - [NeedToMeet](http://www.needtomeet.com): No signup, and everyone can see each other's slots. No timezone awareness.
  - [When2Meet](https://www.when2meet.com): Per-event signup to change your availability. No timezone awareness.
  - [WhenIsGood](http://whenisgood.net): No signup, slots by hours and shows when most or all are free. Supports timezones.
  - [Doodle](https://doodle.com): Powerful scheduling, date and timezone aware, everyone can see each other's responses. Requires registration.
